...
def gen_plot(rock_list, Earth, moon_dist, window = 1, orb_step = 0, unit_scale = 1, unit_name = 'm', scale=1.):
	...
	for i in rock_list:
	    ...
	    rockCircle = plt.Circle((i.x_pos, i.y_pos), radius = i.radius*scale, color = 'b')
