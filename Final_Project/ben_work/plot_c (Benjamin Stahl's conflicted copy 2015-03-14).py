...
def gen_plot(rock_list, Earth, moon_dist, max_mass, max_index, dist_scale, save, window = 1, orb_step = 0, unit_conv = (1.,'m'),p_scale = 1.,r_scale = 1.,n_col=0.0,frac_comp = 0.0,count=-1):
